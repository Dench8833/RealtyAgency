...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\DenisRepository' => function () {
    return ($this->privates['App\Repository\DenisRepository'] ?? $this->load('getDenisRepositoryService.php'));
