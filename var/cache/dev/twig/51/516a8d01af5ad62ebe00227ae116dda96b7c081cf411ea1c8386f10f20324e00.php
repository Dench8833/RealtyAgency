...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "@SonataAdmin/CRUD/list_html.html.twig", "/home/denische/phpStormProjects/RealtyAgency/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_html.html.twig");
    }
}
