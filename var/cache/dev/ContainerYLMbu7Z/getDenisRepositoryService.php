...
// Returns the private 'App\Repository\DenisRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DenisRepository.php';

return $this->privates['App\Repository\DenisRepository'] = new \App\Repository\DenisRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
